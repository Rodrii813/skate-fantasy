                  ...
                  {comp.events.map((event) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {/* Botones de acción directos — apilados a ancho completo
                            en móvil (antes eran 3 flex-1 en una sola fila y el
                            texto se apretujaba/desbordaba en pantallas estrechas) */}
                        <div className="grid grid-cols-1 sm:flex sm:items-center gap-2 w-full md:w-auto">
                          <Link
                            href={`/competitions/${comp.id}?event=${event.id}`}
                            className="sm:flex-none text-center bg-slate-800 hover:bg-slate-700 text-slate-200 text-xs font-semibold px-3.5 py-2 rounded-lg border border-slate-700 transition"
                          >
                            Hub y Resultados
                          </Link>
                          ...
                          <Link
                            ...
                            className="sm:flex-none text-center bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-semibold px-3.5 py-2 rounded-lg transition shadow-sm"
                          >
                            ✨ Fantasy
                          </Link>
                        </div>
